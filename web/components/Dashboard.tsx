  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <section data-match-column="prediction" className="drawer-scroll order-1 flex min-h-0 flex-col border-b border-[var(--line)] p-3 xl:relative xl:order-2 xl:h-full xl:overflow-y-auto xl:border-b-0 xl:border-r">
            <FocusCard m={m} meta={meta} live={live} poly={poly} weather={weather} kalshi={kalshi} liveEntry={liveEntry} hideBook variant="console" />
          </section>
          <section data-match-column="stats" className="drawer-scroll order-2 flex min-h-0 flex-col border-b border-[var(--line)] p-3 xl:order-1 xl:overflow-y-auto xl:border-b-0 xl:border-r">
            {isStarted ? (
