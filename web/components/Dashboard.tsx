  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <section data-match-column="prediction" className="drawer-scroll order-1 flex min-h-0 flex-col border-b border-[var(--line)] p-3 xl:order-2 xl:overflow-y-auto xl:border-b-0 xl:border-r">
